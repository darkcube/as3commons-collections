...
package org.as3commons.collections.fx.iterators {
	...
	/**
	 * Implementation of the <code>SortedList</code> iterator that also implements <code>IViewCursor</code>.
	 * 
	 * @author Timothy Lusk 11.23.2011
	 */
	public class SortedListIteratorFx extends SortedListIterator implements IViewCursor {
		...
		/**
		 * SortedListIteratorFx constructor.
		 * 
		 ...
		 */
		public function SortedListIteratorFx(sortedMap : SortedListFx, index : uint = 0) {
			_eventDispatcher = new EventDispatcher(this);
			_fxCollection = sortedMap;
			super(sortedMap, index);
		}
		...
		{
			return new SortedListIteratorBookmark(CursorBookmark.CURRENT.value, index);
		}
		...
		public function seek(bookmark:CursorBookmark, offset:int = 0, prefetch:int = 0):void
		{
			...
			{
				newIndex = SortedListIteratorBookmark(bookmark).currentIndex;
			}
...
/**
 *  @private
 *  Encapsulates the positional aspects of a cursor within an SortedListIteratorBookmark.
 *  Only the SortedListIteratorBookmark should construct this.
 */
internal class SortedListIteratorBookmark extends CursorBookmark
{
	 ...
	 *  @private
	 */
	public function SortedListIteratorBookmark(value:Object,
										       currentIndex:int)
	{
		super(value);
