...
package org.as3commons.collections.fx.iterators {
	...
	/**
	 * Implementation of the <code>SortedMap</code> iterator that also implements <code>IViewCursor</code>.
	 * 
	 * @author Timothy Lusk 11.23.2011
	 */
	public class SortedMapIteratorFx extends SortedMapIterator implements IViewCursor {
		 ...
		 */
		protected var _fxCollection : SortedMapFx;
		
		/**
		 * SortedMapIteratorFx constructor.
		 * 
		 ...
		 */
		public function SortedMapIteratorFx(sortedMap : SortedMapFx, next : SortedMapNode) {
		...
		{
			return new SortedMapIteratorBookmark(CursorBookmark.CURRENT.value, _current);
		}
		...
		public function seek(bookmark:CursorBookmark, offset:int = 0, prefetch:int = 0):void
		{
			...
			{
				_current = SortedMapIteratorBookmark(bookmark).currentNode;
				if( _current != null )
				{
...
/**
 *  @private
 *  Encapsulates the positional aspects of a cursor within an SortedMapIteratorBookmark.
 *  Only the SortedMapIteratorBookmark should construct this.
 */
internal class SortedMapIteratorBookmark extends CursorBookmark
{
	 ...
	 *  @private
	 */
	public function SortedMapIteratorBookmark(value:Object,
