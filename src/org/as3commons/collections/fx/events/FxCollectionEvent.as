...
package org.as3commons.collections.fx.events {
	 ...
	 * 
	 * <p>The <code>FxCollectionEvent</code> is the base class of all events dispatched
	 ...
	 * 
	 * <p>A collection event has only one event type <code>FxCollectionEvent.COLLECTION_CHANGED</code>.
	 * The kind of the event can be distinguished by the event <code>kind</code> property.</p>
	 * 
	 * <ul>
	 * <li><code>FxCollectionEvent.ITEM_ADDED</code> - An item (or a number of items) has been added.</li>
	 * <li><code>FxCollectionEvent.ITEM_REPLACED</code> - The item a specific position has been replaced.</li>
	 * <li><code>FxCollectionEvent.ITEM_REMOVED</code> - An item (or a number of items) has been removed.</li>
	 * <li><code>FxCollectionEvent.RESET</code> - The collection has been changed so drastically that atomic add,
	 * replace or remove events do not suffice (clear, sort, reverse or any other reset).</li>
	 * </ul>
	 * 
	 * <p><strong><code>FxCollectionEvent</code> subclasses</strong></p>
	 * 
	 * <p>To reflect its particular semantic, each bindable collection dispatch its custom specialised
	 * form of the <code>FxCollectionEvent</code>. The custom events add distinctive access properties
	 * such as index, item or key. You need to downcast the general FxCollectionEvent to the event type
	 ...
	 */
	public class FxCollectionEvent extends Event {
		 ...
		 * <tr>
		 * <td>type</td>
		 * <td>FxCollectionEvent.COLLECTION_CHANGED</td>
		 * </tr>
		 * 
		 * <tr>
		 * <td>kind</td>
		 * <td>FxCollectionEvent.ITEM_ADDED - Item (or items) has been added.<br />
		 * FxCollectionEvent.ITEM_REPLACED - Item has been replaced.<br />
		 * FxCollectionEvent.ITEM_REMOVED - Item (or items) has been removed.<br />
		 * FxCollectionEvent.RESET - Collection has changed drastically.</td>
		 * </tr>
		 * 
		 * <tr>
		 * <td>item<br />
		 ...
		 * The affected item.
		 * 
		 * <p>Only set for the event kinds <code>FxCollectionEvent.ITEM_ADDED</code>,
		 * <code>FxCollectionEvent.ITEM_REPLACED</code>, ITEM_REMOVED.</p>
		 * 
		 ...
		 * 
		 * <p>Only set for the event kinds <code>FxCollectionEvent.ITEM_ADDED</code>,
		 * <code>FxCollectionEvent.ITEM_REPLACED</code>, <code>FxCollectionEvent.ITEM_REMOVED</code>.</p>
		 * 
		 ...
		 * <code>FxCollectionEvent.ITEM_REPLACED</code>, <code>FxCollectionEvent.ITEM_REMOVED</code>.</p>
		 * 
		 * <p><code>-1</code> if the event kind is <code>FxCollectionEvent.RESET</code>.</p>
		 */
		public var numItems : int;
		
		/**
		 * FxCollectionEvent constructor.
		 */
		public function FxCollectionEvent() {
		 ...
		 * change or <code>null</code> if the event kind is <code>FxCollectionEvent.RESET</code>.
		 */
